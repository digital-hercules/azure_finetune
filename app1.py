...
def summarize_paragraphs(paragraphs, max_length=6, min_length=30):
    summaries = []
...
def upload():
    ...
    try:
        ...
        return jsonify({"message": "Fine-tuning job created successfully", "job_id": job_status.fine_tuned_model}), 200
